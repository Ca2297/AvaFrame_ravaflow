...
# Defining arguments
wkdir <- './data/avaBowl/Avaflow_Input/'  #working directory
prefix <- 'bo_'  #prefix for file names
aflag <- 1  #control for additional output
tflag <- 0  #control for tsunami
model <- 7  #model
ymax0 <- 2.500000  #coordinates defining map boundaries
ymin0 <- -4997.500000
xmin0 <- 997.500000
xmax0 <- 5997.500000
cellsize <- 25.000000
...
maxhflow <- 5.614493
maxtflow <- 2014887.375000
maxpflow <- 830921.875000
maxvflow <- 25.490334
maxtreach <- 301.462708
maxhtsun <- 0.000000
maxhentr <- -0.000000
maxhdep <- 0.000000
mapprof <- 0
