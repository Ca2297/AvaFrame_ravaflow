...
# Defining arguments
wkdir <- './data/avaGar/Avaflow_Input_Output/'  #working directory
prefix <- 'gar_'  #prefix for file names
aflag <- 0  #control for additional output
tflag <- 0  #control for tsunami
model <- 1  #model
ymax0 <- 352637.468750  #coordinates defining map boundaries
ymin0 <- 350697.468750
xmin0 <- 247320.750000
xmax0 <- 249920.750000
cellsize <- 20.000000
...
maxhflow <- 7.231583
maxtflow <- 5802203.000000
maxpflow <- 1250454.000000
maxvflow <- 30.434557
maxtreach <- 298.099579
maxhtsun <- 0.000000
maxhentr <- -0.000000
maxhdep <- 0.000000
mapprof <- 0
