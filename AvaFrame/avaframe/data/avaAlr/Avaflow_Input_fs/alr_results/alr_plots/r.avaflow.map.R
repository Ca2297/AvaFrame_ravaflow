...
# Defining arguments
wkdir <- './data/avaAlr/Avaflow_Input_Output/'  #working directory
prefix <- 'alr_'  #prefix for file names
aflag <- 0  #control for additional output
tflag <- 0  #control for tsunami
model <- 1  #model
ymax0 <- 381881.000000  #coordinates defining map boundaries
ymin0 <- 377301.000000
xmin0 <- 255202.078125
xmax0 <- 257282.078125
cellsize <- 20.000000
...
maxhflow <- 3.732021
maxtflow <- 3343559.500000
maxpflow <- 1387758.750000
maxvflow <- 32.061962
maxtreach <- 300.792389
maxhtsun <- 0.000000
maxhentr <- -0.000000
maxhdep <- 0.000000
mapprof <- 0
...
ortho2 <- 'None'
ortho3 <- 'None'
phase1 <- 2  #first phase
phase2 <- 0  #second phase
phase3 <- 0  #third phase
