...
# Defining arguments
wkdir <- './data/avaSalk/Avaflow_Input_Output/'  #working directory
prefix <- 'slk_'  #prefix for file names
aflag <- 0  #control for additional output
tflag <- 0  #control for tsunami
model <- 7  #model
ymax0 <- 8524800.000000  #coordinates defining map boundaries
ymin0 <- 8523000.000000
xmin0 <- 761600.000000
xmax0 <- 765300.000000
cellsize <- 12.500000
tint <- 10.000000
...
maxhflow <- 91.015732
maxtflow <- 42415268.000000
maxpflow <- 5079319.000000
maxvflow <- 61.338882
maxtreach <- 300.228302
maxhtsun <- 0.000000
maxhentr <- 4.749044
maxhdep <- 0.000000
mapprof <- 0
