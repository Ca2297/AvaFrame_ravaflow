...
# Defining arguments
wkdir <- './data/avaKot/Avaflow_Input_Output/'  #working directory
prefix <- 'gar_'  #prefix for file names
aflag <- 0  #control for additional output
tflag <- 0  #control for tsunami
model <- 7  #model
ymax0 <- 378770.312500  #coordinates defining map boundaries
ymin0 <- 376270.312500
xmin0 <- 176963.437500
xmax0 <- 178723.437500
cellsize <- 20.000000
...
maxhflow <- 5.382200
maxtflow <- 7191081.000000
maxpflow <- 1833229.750000
maxvflow <- 36.850346
maxtreach <- 100.589630
maxhtsun <- 0.000000
maxhentr <- -0.000000
maxhdep <- 0.000000
mapprof <- 0
